...
背後に置きます。Python wrapper 関連資料は 0.1.1.1 validation line では
reference-only であり、PyPI package として配布しません。次の公式 v0.1.2 正典シリーズ
では NuGet と合わせて更新済み PyPI package を公開する前提です。
